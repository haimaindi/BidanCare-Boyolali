...
CREATE TABLE IF NOT EXISTS pendaftaran_pasien (
  ...
  no_antrean VARCHAR(50) NOT NULL,
  ...
  sumber_pendaftaran VARCHAR(20) NOT NULL CHECK (sumber_pendaftaran IN ('Online', 'Offline')),
  status VARCHAR(50) NOT NULL DEFAULT 'Menunggu' CHECK (status IN ('Menunggu', 'Menunggu Check-In', 'Diperiksa', 'Selesai', 'Batal')),
